...
function UCSBDiningCommonsMenuForm({ initialContents, submitAction, buttonLabel = "Create" }) {
    ...
    const testIdPrefix = "UCSBDiningCommonsMenuForm";
...
export default UCSBDiningCommonsMenuForm;
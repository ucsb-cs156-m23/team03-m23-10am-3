                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.requesterEmail?.type === 'pattern' && 'Requester Email must be a valid email, e.g. cgaucho@ucsb.edu'}
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.professorEmail?.type === 'pattern' && 'Professor Email must be a valid email, e.g. prof@ucsb.edu'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
                <Col>
